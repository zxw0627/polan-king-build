    ...
    l = n.BufferedBlockAlgorithm = o.extend({
      ...
      _process: function (e) {
        var r,
          ...
          d = t.min(4 * h, o);
        if (h) {
          for (var l = 0; l < h; l += a) this._doProcessBlock(n, l);
          r = n.splice(0, h), i.sigBytes -= d;
        }
...
(function () {
  ...
  var a = o.MD5 = n.extend({
    ...
    _doProcessBlock: function (t, e) {
      ...
      var o = this._hash.words,
        ...
        A = o[2],
        F = o[3];
      x = c(x, b, A, F, a, 7, s[0]), F = c(F, x, b, A, u, 12, s[1]), A = c(A, F, x, b, f, 17, s[2]), b = c(b, A, F, x, p, 22, s[3]), x = c(x, b, A, F, _, 7, s[4]), F = c(F, x, b, A, y, 12, s[5]), A = c(A, F, x, b, g, 17, s[6]), b = c(b, A, F, x, v, 22, s[7]), x = c(x, b, A, F, w, 7, s[8]), F = c(F, x, b, A, S, 12, s[9]), A = c(A, F, x, b, k, 17, s[10]), b = c(b, A, F, x, B, 22, s[11]), x = c(x, b, A, F, m, 7, s[12]), F = c(F, x, b, A, C, 12, s[13]), A = c(A, F, x, b, z, 17, s[14]), x = h(x, b = c(b, A, F, x, H, 22, s[15]), A, F, u, 5, s[16]), F = h(F, x, b, A, g, 9, s[17]), A = h(A, F, x, b, B, 14, s[18]), b = h(b, A, F, x, a, 20, s[19]), x = h(x, b, A, F, y, 5, s[20]), F = h(F, x, b, A, k, 9, s[21]), A = h(A, F, x, b, H, 14, s[22]), b = h(b, A, F, x, _, 20, s[23]), x = h(x, b, A, F, S, 5, s[24]), F = h(F, x, b, A, z, 9, s[25]), A = h(A, F, x, b, p, 14, s[26]), b = h(b, A, F, x, w, 20, s[27]), x = h(x, b, A, F, C, 5, s[28]), F = h(F, x, b, A, f, 9, s[29]), A = h(A, F, x, b, v, 14, s[30]), x = d(x, b = h(b, A, F, x, m, 20, s[31]), A, F, y, 4, s[32]), F = d(F, x, b, A, w, 11, s[33]), A = d(A, F, x, b, B, 16, s[34]), b = d(b, A, F, x, z, 23, s[35]), x = d(x, b, A, F, u, 4, s[36]), F = d(F, x, b, A, _, 11, s[37]), A = d(A, F, x, b, v, 16, s[38]), b = d(b, A, F, x, k, 23, s[39]), x = d(x, b, A, F, C, 4, s[40]), F = d(F, x, b, A, a, 11, s[41]), A = d(A, F, x, b, p, 16, s[42]), b = d(b, A, F, x, g, 23, s[43]), x = d(x, b, A, F, S, 4, s[44]), F = d(F, x, b, A, m, 11, s[45]), A = d(A, F, x, b, H, 16, s[46]), x = l(x, b = d(b, A, F, x, f, 23, s[47]), A, F, a, 6, s[48]), F = l(F, x, b, A, v, 10, s[49]), A = l(A, F, x, b, z, 15, s[50]), b = l(b, A, F, x, y, 21, s[51]), x = l(x, b, A, F, m, 6, s[52]), F = l(F, x, b, A, p, 10, s[53]), A = l(A, F, x, b, k, 15, s[54]), b = l(b, A, F, x, u, 21, s[55]), x = l(x, b, A, F, w, 6, s[56]), F = l(F, x, b, A, H, 10, s[57]), A = l(A, F, x, b, g, 15, s[58]), b = l(b, A, F, x, C, 21, s[59]), x = l(x, b, A, F, _, 6, s[60]), F = l(F, x, b, A, B, 10, s[61]), A = l(A, F, x, b, f, 15, s[62]), b = l(b, A, F, x, S, 21, s[63]), o[0] = o[0] + x | 0, o[1] = o[1] + b | 0, o[2] = o[2] + A | 0, o[3] = o[3] + F | 0;
    },
    _doFinalize: function () {
      ...
      for (var a = this._hash, c = a.words, h = 0; h < 4; h++) {
        var d = c[h];
        c[h] = 16711935 & (d << 8 | d >>> 24) | 4278255360 & (d << 24 | d >>> 8);
      }
      return a;
    },
    clone: function () {
      ...
      _doProcessBlock: function (t, e) {
        for (var r = this._hash.words, i = r[0], n = r[1], s = r[2], a = r[3], c = r[4], h = 0; h < 80; h++) {
          if (h < 16) o[h] = 0 | t[e + h];else {
            var d = o[h - 3] ^ o[h - 8] ^ o[h - 14] ^ o[h - 16];
            o[h] = d << 1 | d >>> 31;
          }
  ...
  var c = [],
    h = o.SHA256 = n.extend({
      ...
      _doProcessBlock: function (t, e) {
        for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], h = r[4], d = r[5], l = r[6], u = r[7], f = 0; f < 64; f++) {
          if (f < 16) c[f] = 0 | t[e + f];else {
            var p = c[f - 15],
              _ = (p << 25 | p >>> 7) ^ (p << 14 | p >>> 18) ^ p >>> 3,
              y = c[f - 2],
              g = (y << 15 | y >>> 17) ^ (y << 13 | y >>> 19) ^ y >>> 10;
            c[f] = _ + c[f - 7] + g + c[f - 16];
          }
          var v = i & n ^ i & o ^ n & o,
            w = (i << 30 | i >>> 2) ^ (i << 19 | i >>> 13) ^ (i << 10 | i >>> 22),
            S = u + ((h << 26 | h >>> 6) ^ (h << 21 | h >>> 11) ^ (h << 7 | h >>> 25)) + (h & d ^ ~h & l) + a[f] + c[f];
          u = l, l = d, d = h, h = s + S | 0, s = o, o = n, n = i, i = S + (w + v) | 0;
        }
        r[0] = r[0] + i | 0, r[1] = r[1] + n | 0, r[2] = r[2] + o | 0, r[3] = r[3] + s | 0, r[4] = r[4] + h | 0, r[5] = r[5] + d | 0, r[6] = r[6] + l | 0, r[7] = r[7] + u | 0;
      },
      _doFinalize: function () {
        var e = this._data,
          r = e.words,
    ...
    l = n.RIPEMD160 = i.extend({
      ...
      _doProcessBlock: function (t, e) {
        ...
        var l,
          ...
          R = a.words,
          J = c.words;
        for (B = l = b[0], m = v = b[1], C = w = b[2], z = S = b[3], H = k = b[4], r = 0; r < 80; r += 1) x = l + t[e + I[r]] | 0, x += r < 16 ? u(v, w, S) + A[0] : r < 32 ? f(v, w, S) + A[1] : r < 48 ? p(v, w, S) + A[2] : r < 64 ? _(v, w, S) + A[3] : y(v, w, S) + A[4], x = (x = g(x |= 0, R[r])) + k | 0, l = k, k = S, S = g(w, 10), w = v, v = x, x = B + t[e + D[r]] | 0, x += r < 16 ? y(m, C, z) + F[0] : r < 32 ? _(m, C, z) + F[1] : r < 48 ? p(m, C, z) + F[2] : r < 64 ? f(m, C, z) + F[3] : u(m, C, z) + F[4], x = (x = g(x |= 0, J[r])) + H | 0, B = H, H = z, z = g(C, 10), C = m, m = x;
        x = b[1] + w + z | 0, b[1] = b[2] + S + H | 0, b[2] = b[3] + k + B | 0, b[3] = b[4] + l + m | 0, b[4] = b[0] + v + C | 0, b[0] = x;
      },
      _doFinalize: function () {
        var t = this._data,
          e = t.words,
  ...
  t.RIPEMD160 = i._createHelper(l), t.HmacRIPEMD160 = i._createHmacHelper(l);
}(Math), function () {
  var t = CryptoJS,
    e = t.lib.Base,
    r = t.enc.Utf8;
  ...
  var t = CryptoJS,
    ...
    a = n.PBKDF2 = r.extend({
      ...
      compute: function (t, e) {
        for (var r = this.cfg, n = s.create(r.hasher, t), o = i.create(), a = i.create([1]), c = o.words, h = a.words, d = r.keySize, l = r.iterations; c.length < d;) {
          var u = n.update(e).finalize(a);
          n.reset();
          for (var f = u.words, p = f.length, _ = u, y = 1; y < l; y++) {
            _ = n.finalize(_), n.reset();
            for (var g = _.words, v = 0; v < p; v++) f[v] ^= g[v];
          }
          o.concat(u), h[0]++;
        }
    ...
    s = n.EvpKDF = r.extend({
      ...
      compute: function (t, e) {
        for (var r, n = this.cfg, o = n.hasher.create(), s = i.create(), a = s.words, c = n.keySize, h = n.iterations; a.length < c;) {
          ...
          for (var d = 1; d < h; d++) r = o.finalize(r), o.reset();
          s.concat(r);
        }
  ...
  var l = s.SHA3 = n.extend({
    ...
    _doProcessBlock: function (t, e) {
      for (var r = this._state, i = this.blockSize / 2, n = 0; n < i; n++) {
        var o = t[e + 2 * n],
          s = t[e + 2 * n + 1];
        o = 16711935 & (o << 8 | o >>> 24) | 4278255360 & (o << 24 | o >>> 8), s = 16711935 & (s << 8 | s >>> 24) | 4278255360 & (s << 24 | s >>> 8), (b = r[n]).high ^= s, b.low ^= o;
      }
      for (var l = 0; l < 24; l++) {
        for (var u = 0; u < 5; u++) {
          for (var f = 0, p = 0, _ = 0; _ < 5; _++) f ^= (b = r[u + 5 * _]).high, p ^= b.low;
          var y = d[u];
          y.high = f, y.low = p;
        }
        for (u = 0; u < 5; u++) {
          var g = d[(u + 4) % 5],
            ...
            w = v.high,
            S = v.low;
          for (f = g.high ^ (w << 1 | S >>> 31), p = g.low ^ (S << 1 | w >>> 31), _ = 0; _ < 5; _++) (b = r[u + 5 * _]).high ^= f, b.low ^= p;
        }
        for (var k = 1; k < 25; k++) {
          var B = (b = r[k]).high,
            m = b.low,
            C = a[k];
          C < 32 ? (f = B << C | m >>> 32 - C, p = m << C | B >>> 32 - C) : (f = m << C - 32 | B >>> 64 - C, p = B << C - 32 | m >>> 64 - C);
          var z = d[c[k]];
          z.high = f, z.low = p;
        }
        var H = d[0],
          x = r[0];
        for (H.high = x.high, H.low = x.low, u = 0; u < 5; u++) for (_ = 0; _ < 5; _++) {
          var b = r[k = u + 5 * _],
            A = d[k],
            F = d[(u + 1) % 5 + 5 * _],
            I = d[(u + 2) % 5 + 5 * _];
          b.high = A.high ^ ~F.high & I.high, b.low = A.low ^ ~F.low & I.low;
        }
        b = r[0];
        var D = h[l];
        b.high ^= D.high, b.low ^= D.low;
      }
    },
    _doFinalize: function () {
      var e = this._data,
      ...
      for (var s = this._state, a = this.cfg.outputLength / 8, c = a / 8, h = [], d = 0; d < c; d++) {
        var l = s[d],
          u = l.high,
          f = l.low;
        u = 16711935 & (u << 8 | u >>> 24) | 4278255360 & (u << 24 | u >>> 8), f = 16711935 & (f << 8 | f >>> 24) | 4278255360 & (f << 24 | f >>> 8), h.push(f), h.push(u);
      }
  ...
  e.SHA3 = n._createHelper(l), e.HmacSHA3 = n._createHmacHelper(l);
}(Math), function () {
  var t = CryptoJS,
    e = t.lib.Hasher,
    r = t.x64,
  ...
  var h = o.SHA512 = e.extend({
    ...
    _doProcessBlock: function (t, e) {
      for (var r = this._hash.words, i = r[0], n = r[1], o = r[2], s = r[3], h = r[4], d = r[5], l = r[6], u = r[7], f = i.high, p = i.low, _ = n.high, y = n.low, g = o.high, v = o.low, w = s.high, S = s.low, k = h.high, B = h.low, m = d.high, C = d.low, z = l.high, H = l.low, x = u.high, b = u.low, A = f, F = p, I = _, D = y, R = g, J = v, E = w, M = S, U = k, O = B, G = m, L = C, P = z, W = H, T = x, q = b, j = 0; j < 80; j++) {
        var K,
          X,
          N = c[j];
        if (j < 16) X = N.high = 0 | t[e + 2 * j], K = N.low = 0 | t[e + 2 * j + 1];else {
          var Z = c[j - 15],
            V = Z.high,
            Y = Z.low,
            ...
            ht = ct.high,
            dt = ct.low;
          X = (X = (X = $ + st + ((K = Q + at) >>> 0 < Q >>> 0 ? 1 : 0)) + it + ((K += nt) >>> 0 < nt >>> 0 ? 1 : 0)) + ht + ((K += dt) >>> 0 < dt >>> 0 ? 1 : 0), N.high = X, N.low = K;
        }
        var lt,
          ut = U & G ^ ~U & P,
          ft = O & L ^ ~O & W,
          pt = A & I ^ A & R ^ I & R,
          _t = F & D ^ F & J ^ D & J,
          yt = (A >>> 28 | F << 4) ^ (A << 30 | F >>> 2) ^ (A << 25 | F >>> 7),
          gt = (F >>> 28 | A << 4) ^ (F << 30 | A >>> 2) ^ (F << 25 | A >>> 7),
          vt = (U >>> 14 | O << 18) ^ (U >>> 18 | O << 14) ^ (U << 23 | O >>> 9),
          wt = (O >>> 14 | U << 18) ^ (O >>> 18 | U << 14) ^ (O << 23 | U >>> 9),
          St = a[j],
          kt = St.high,
          Bt = St.low,
          mt = T + vt + ((lt = q + wt) >>> 0 < q >>> 0 ? 1 : 0),
          Ct = gt + _t;
        T = P, q = W, P = G, W = L, G = U, L = O, U = E + (mt = (mt = (mt = mt + ut + ((lt += ft) >>> 0 < ft >>> 0 ? 1 : 0)) + kt + ((lt += Bt) >>> 0 < Bt >>> 0 ? 1 : 0)) + X + ((lt += K) >>> 0 < K >>> 0 ? 1 : 0)) + ((O = M + lt | 0) >>> 0 < M >>> 0 ? 1 : 0) | 0, E = R, M = J, R = I, J = D, I = A, D = F, A = mt + (yt + pt + (Ct >>> 0 < gt >>> 0 ? 1 : 0)) + ((F = lt + Ct | 0) >>> 0 < lt >>> 0 ? 1 : 0) | 0;
      }
      p = i.low = p + F, i.high = f + A + (p >>> 0 < F >>> 0 ? 1 : 0), y = n.low = y + D, n.high = _ + I + (y >>> 0 < D >>> 0 ? 1 : 0), v = o.low = v + J, o.high = g + R + (v >>> 0 < J >>> 0 ? 1 : 0), S = s.low = S + M, s.high = w + E + (S >>> 0 < M >>> 0 ? 1 : 0), B = h.low = B + O, h.high = k + U + (B >>> 0 < O >>> 0 ? 1 : 0), C = d.low = C + L, d.high = m + G + (C >>> 0 < L >>> 0 ? 1 : 0), H = l.low = H + W, l.high = z + P + (H >>> 0 < W >>> 0 ? 1 : 0), b = u.low = b + q, u.high = x + T + (b >>> 0 < q >>> 0 ? 1 : 0);
    },
    _doFinalize: function () {
      var t = this._data,
        e = t.words,
  ...
  (function () {
    ...
    for (e = 0; e < 256; e++) {
      ...
      o[r] = v << 24 | v >>> 8, s[r] = v << 16 | v >>> 16, a[r] = v << 8 | v >>> 24, c[r] = v, v = 16843009 * g ^ 65537 * y ^ 257 * _ ^ 16843008 * r, h[p] = v << 24 | v >>> 8, d[p] = v << 16 | v >>> 16, l[p] = v << 8 | v >>> 24, u[p] = v, r ? (r = _ ^ t[t[t[g ^ _]]], f ^= t[t[f]]) : r = f = 1;
    }
  })();
    ...
    p = r.AES = e.extend({
      _doReset: function () {
        if (!this._nRounds || this._keyPriorReset !== this._key) {
          for (var t = this._keyPriorReset = this._key, e = t.words, r = t.sigBytes / 4, n = 4 * ((this._nRounds = r + 6) + 1), o = this._keySchedule = [], s = 0; s < n; s++) s < r ? o[s] = e[s] : (p = o[s - 1], s % r ? r > 6 && s % r == 4 && (p = i[p >>> 24] << 24 | i[p >>> 16 & 255] << 16 | i[p >>> 8 & 255] << 8 | i[255 & p]) : (p = i[(p = p << 8 | p >>> 24) >>> 24] << 24 | i[p >>> 16 & 255] << 16 | i[p >>> 8 & 255] << 8 | i[255 & p], p ^= f[s / r | 0] << 24), o[s] = o[s - r] ^ p);
          for (var a = this._invKeySchedule = [], c = 0; c < n; c++) {
            if (s = n - c, c % 4) var p = o[s];else p = o[s - 4];
            a[c] = c < 4 || s <= 4 ? p : h[i[p >>> 24]] ^ d[i[p >>> 16 & 255]] ^ l[i[p >>> 8 & 255]] ^ u[i[255 & p]];
          }
        }
      },
      ...
      decryptBlock: function (t, e) {
        var r = t[e + 1];
        t[e + 1] = t[e + 3], t[e + 3] = r, this._doCryptBlock(t, e, this._invKeySchedule, h, d, l, u, n), r = t[e + 1], t[e + 1] = t[e + 3], t[e + 3] = r;
      },
      _doCryptBlock: function (t, e, r, i, n, o, s, a) {
        for (var c = this._nRounds, h = t[e] ^ r[0], d = t[e + 1] ^ r[1], l = t[e + 2] ^ r[2], u = t[e + 3] ^ r[3], f = 4, p = 1; p < c; p++) {
          var _ = i[h >>> 24] ^ n[d >>> 16 & 255] ^ o[l >>> 8 & 255] ^ s[255 & u] ^ r[f++],
            y = i[d >>> 24] ^ n[l >>> 16 & 255] ^ o[u >>> 8 & 255] ^ s[255 & h] ^ r[f++],
            g = i[l >>> 24] ^ n[u >>> 16 & 255] ^ o[h >>> 8 & 255] ^ s[255 & d] ^ r[f++],
            v = i[u >>> 24] ^ n[h >>> 16 & 255] ^ o[d >>> 8 & 255] ^ s[255 & l] ^ r[f++];
          h = _, d = y, l = g, u = v;
        }
        _ = (a[h >>> 24] << 24 | a[d >>> 16 & 255] << 16 | a[l >>> 8 & 255] << 8 | a[255 & u]) ^ r[f++], y = (a[d >>> 24] << 24 | a[l >>> 16 & 255] << 16 | a[u >>> 8 & 255] << 8 | a[255 & h]) ^ r[f++], g = (a[l >>> 24] << 24 | a[u >>> 16 & 255] << 16 | a[h >>> 8 & 255] << 8 | a[255 & d]) ^ r[f++], v = (a[u >>> 24] << 24 | a[h >>> 16 & 255] << 16 | a[d >>> 8 & 255] << 8 | a[255 & l]) ^ r[f++], t[e] = _, t[e + 1] = y, t[e + 2] = g, t[e + 3] = v;
      },
      keySize: 8
    });
    ...
    d = n.DES = i.extend({
      _doReset: function () {
        ...
        for (var n = this._subKeys = [], c = 0; c < 16; c++) {
          var h = n[c] = [],
            d = a[c];
          for (r = 0; r < 24; r++) h[r / 6 | 0] |= e[(s[r] - 1 + d) % 28] << 31 - r % 6, h[4 + (r / 6 | 0)] |= e[28 + (s[r + 24] - 1 + d) % 28] << 31 - r % 6;
      ...
      _doCryptBlock: function (t, e, r) {
        this._lBlock = t[e], this._rBlock = t[e + 1], l.call(this, 4, 252645135), l.call(this, 16, 65535), u.call(this, 2, 858993459), u.call(this, 8, 16711935), l.call(this, 1, 1431655765);
        for (var i = 0; i < 16; i++) {
          for (var n = r[i], o = this._lBlock, s = this._rBlock, a = 0, d = 0; d < 8; d++) a |= c[d][((s ^ n[d]) & h[d]) >>> 0];
          this._lBlock = s, this._rBlock = o ^ a;
        }
        var f = this._lBlock;
        this._lBlock = this._rBlock, this._rBlock = f, l.call(this, 1, 1431655765), u.call(this, 8, 16711935), u.call(this, 2, 858993459), l.call(this, 16, 65535), l.call(this, 4, 252645135), t[e] = this._lBlock, t[e + 1] = this._rBlock;
      },
      keySize: 2,
      ivSize: 2,
      blockSize: 2
  ...
  var f = n.TripleDES = i.extend({
    _doReset: function () {
      ...
      this._des1 = d.createEncryptor(r.create(e)), this._des2 = d.createEncryptor(r.create(i)), this._des3 = d.createEncryptor(r.create(n));
    },
    encryptBlock: function (t, e) {
      ...
      _doReset: function () {
        ...
        if (e) {
          var o = e.words,
            ...
            l = h >>> 16 | 4294901760 & d,
            u = d << 16 | 65535 & h;
          for (n[0] ^= h, n[1] ^= l, n[2] ^= d, n[3] ^= u, n[4] ^= h, n[5] ^= l, n[6] ^= d, n[7] ^= u, r = 0; r < 4; r++) a.call(this);
        }
      },
      _doProcessBlock: function (t, e) {
        var r = this._X;
      ...
      _doReset: function () {
        ...
        if (e) {
          var o = e.words,
            ...
            l = h >>> 16 | 4294901760 & d,
            u = d << 16 | 65535 & h;
          for (i[0] ^= h, i[1] ^= l, i[2] ^= d, i[3] ^= u, i[4] ^= h, i[5] ^= l, i[6] ^= d, i[7] ^= u, n = 0; n < 4; n++) a.call(this);
        }
      },
      _doProcessBlock: function (t, e) {
        var r = this._X;
  ...
  class r {
    ...
    static async init() {
      "v2" == r.version && (await r.authorization().catch(t => t));
      let t = {
        user_id: 1,
        user_type: 1,
      ...
      if (window.tt) {
        let e = await r.getLoginParams();
        console.error(e), await r.login(e).then(e => {
          e.user_id && (t = e);
        });
      } else await r.login({
        uid: "1"
      ...
      r.loginInfo = t, zs_sdk.zs_dyzt.initDyzt();
    }
    static getUrl(t) {
      return null == r.mapWebApi[t] ? (console.log("\u975e\u6cd5\u7f51\u7edc\u63a5\u53e3\uff1a " + t, "Network"), null) : r.listDomain[0] + "/" + r.version + "/" + r.mapWebApi[t];
    }
    static obj2arg(t) {
      var e = [];
    ...
    static async post(t, e, r, i, n) {
      return null == n && (n = 3), new zs_sdk.Coop((t, e) => e());
    }
    static request(t, i, n) {
      return new zs_sdk.Coop((o, s) => {
        let a = r.getUrl(t);
    ...
    static async authorization() {
      let t = {};
      return t.gid = gameCfg.gid, r.request("auth", t);
    }
    static async login(t) {
      null == t && (t = {}), t.gid = gameCfg.gid;
      let e = "";
      return window.tt && (e = window.tt.getLaunchOptionsSync().scene.toString()), t.scene = e, console.log("\u767b\u5f55\u53c2\u6570\uff1a", "Network", t), r.request("login", t, null);
    }
    static video() {
      let t = {
        gid: gameCfg.gid,
        uid: r.loginInfo.user_id,
        uvid: 1,
        video_id: "default",
        video_name: "\u9ed8\u8ba4\u89c6\u9891",
        video_type: 3,
    ...
    static dyReport(t) {
      ...
      return r.request("dyReport", e, null);
    }
    static ztReport(t) {
      let e = {
        gid: gameCfg.gid,
      ...
      return r.request("ztReport", e, null);
    }
    static async getLoginParams() {
      return new Promise(t => {
        tt.login({
          force: !1,
          success: e => {
            e.code || e.anonymousCode ? t({
              code: e.code,
  ...
  r.loginInfo = null, r.ready = !1, r.version = "v2", r.domainIdx = -1, r.city = null, r.timestamp = null, r.defaultData = {}, r.remoteWebSettingURL = "", r.authorizationToken = "", r.authorizationSecret = "", r.listDomain = [], r.mapWebApi = {
    auth: "game/auth",
    login: "game/login",
    video: "game/video",
    dyReport: "attribution/dyReport",
    ztReport: "attribution/ztReport"
    ...
    static md5(t) {
      var e,
        ...
        h,
        d = Array();
      for (t = this.uTF8Encode(t), d = this.convertToWordArray(t), s = 1732584193, a = 4023233417, c = 2562383102, h = 271733878, e = 0; e < d.length; e += 16) r = s, i = a, n = c, o = h, s = this.FF(s, a, c, h, d[e + 0], 7, 3614090360), h = this.FF(h, s, a, c, d[e + 1], 12, 3905402710), c = this.FF(c, h, s, a, d[e + 2], 17, 606105819), a = this.FF(a, c, h, s, d[e + 3], 22, 3250441966), s = this.FF(s, a, c, h, d[e + 4], 7, 4118548399), h = this.FF(h, s, a, c, d[e + 5], 12, 1200080426), c = this.FF(c, h, s, a, d[e + 6], 17, 2821735955), a = this.FF(a, c, h, s, d[e + 7], 22, 4249261313), s = this.FF(s, a, c, h, d[e + 8], 7, 1770035416), h = this.FF(h, s, a, c, d[e + 9], 12, 2336552879), c = this.FF(c, h, s, a, d[e + 10], 17, 4294925233), a = this.FF(a, c, h, s, d[e + 11], 22, 2304563134), s = this.FF(s, a, c, h, d[e + 12], 7, 1804603682), h = this.FF(h, s, a, c, d[e + 13], 12, 4254626195), c = this.FF(c, h, s, a, d[e + 14], 17, 2792965006), a = this.FF(a, c, h, s, d[e + 15], 22, 1236535329), s = this.GG(s, a, c, h, d[e + 1], 5, 4129170786), h = this.GG(h, s, a, c, d[e + 6], 9, 3225465664), c = this.GG(c, h, s, a, d[e + 11], 14, 643717713), a = this.GG(a, c, h, s, d[e + 0], 20, 3921069994), s = this.GG(s, a, c, h, d[e + 5], 5, 3593408605), h = this.GG(h, s, a, c, d[e + 10], 9, 38016083), c = this.GG(c, h, s, a, d[e + 15], 14, 3634488961), a = this.GG(a, c, h, s, d[e + 4], 20, 3889429448), s = this.GG(s, a, c, h, d[e + 9], 5, 568446438), h = this.GG(h, s, a, c, d[e + 14], 9, 3275163606), c = this.GG(c, h, s, a, d[e + 3], 14, 4107603335), a = this.GG(a, c, h, s, d[e + 8], 20, 1163531501), s = this.GG(s, a, c, h, d[e + 13], 5, 2850285829), h = this.GG(h, s, a, c, d[e + 2], 9, 4243563512), c = this.GG(c, h, s, a, d[e + 7], 14, 1735328473), a = this.GG(a, c, h, s, d[e + 12], 20, 2368359562), s = this.HH(s, a, c, h, d[e + 5], 4, 4294588738), h = this.HH(h, s, a, c, d[e + 8], 11, 2272392833), c = this.HH(c, h, s, a, d[e + 11], 16, 1839030562), a = this.HH(a, c, h, s, d[e + 14], 23, 4259657740), s = this.HH(s, a, c, h, d[e + 1], 4, 2763975236), h = this.HH(h, s, a, c, d[e + 4], 11, 1272893353), c = this.HH(c, h, s, a, d[e + 7], 16, 4139469664), a = this.HH(a, c, h, s, d[e + 10], 23, 3200236656), s = this.HH(s, a, c, h, d[e + 13], 4, 681279174), h = this.HH(h, s, a, c, d[e + 0], 11, 3936430074), c = this.HH(c, h, s, a, d[e + 3], 16, 3572445317), a = this.HH(a, c, h, s, d[e + 6], 23, 76029189), s = this.HH(s, a, c, h, d[e + 9], 4, 3654602809), h = this.HH(h, s, a, c, d[e + 12], 11, 3873151461), c = this.HH(c, h, s, a, d[e + 15], 16, 530742520), a = this.HH(a, c, h, s, d[e + 2], 23, 3299628645), s = this.II(s, a, c, h, d[e + 0], 6, 4096336452), h = this.II(h, s, a, c, d[e + 7], 10, 1126891415), c = this.II(c, h, s, a, d[e + 14], 15, 2878612391), a = this.II(a, c, h, s, d[e + 5], 21, 4237533241), s = this.II(s, a, c, h, d[e + 12], 6, 1700485571), h = this.II(h, s, a, c, d[e + 3], 10, 2399980690), c = this.II(c, h, s, a, d[e + 10], 15, 4293915773), a = this.II(a, c, h, s, d[e + 1], 21, 2240044497), s = this.II(s, a, c, h, d[e + 8], 6, 1873313359), h = this.II(h, s, a, c, d[e + 15], 10, 4264355552), c = this.II(c, h, s, a, d[e + 6], 15, 2734768916), a = this.II(a, c, h, s, d[e + 13], 21, 1309151649), s = this.II(s, a, c, h, d[e + 4], 6, 4149444226), h = this.II(h, s, a, c, d[e + 11], 10, 3174756917), c = this.II(c, h, s, a, d[e + 2], 15, 718787259), a = this.II(a, c, h, s, d[e + 9], 21, 3951481745), s = this.addUnsigned(s, r), a = this.addUnsigned(a, i), c = this.addUnsigned(c, n), h = this.addUnsigned(h, o);
      return (this.wordToHex(s) + this.wordToHex(a) + this.wordToHex(c) + this.wordToHex(h)).toLowerCase();
    }
  }, t.zs_network = r;
}(window.zs_sdk = window.zs_sdk || {}), window.zs_sdk = window.zs_sdk || {}, function (t) {
  function e(t, e, r) {
    let i = new Promise(t);
    if (e) {
      if (r) {
  ...
  class e {
    static initDyzt() {
      e.dyReport(e.event_type.active), e.reportNextDayOpen();
    }
    static dyReport(t) {
      if (!window.tt) return;
      let r = window.tt.getLaunchOptionsSync().query.clickid;
      if (console.error("click_id" + r), !r && (console.error("\u6ca1\u6709\u83b7\u53d6\u5230click_id"), r = "", t == e.event_type.active)) return;
      let i = window.tt.getLaunchOptionsSync().query.channel;
      console.error("\u6e20\u9053" + i), i || (i = "", t != e.event_type.active && (i = zs_sdk.zs_network.loginInfo.channel));
      let n = window.tt.getLaunchOptionsSync().query.creativeid;
      console.error("\u521b\u610fid" + n), n || (n = "");
      let o = window.tt.getLaunchOptionsSync().query.advertiser_id;
      console.error("\u5e7f\u544a\u4e3bid" + o), o || (o = "");
      let s = window.tt.getLaunchOptionsSync().query.adid;
      console.error("1.0\u8ba1\u5212id" + s), s || (s = "");
      let a = window.tt.getLaunchOptionsSync().query.request_id;
      console.error("\u8bf7\u6c42request_id" + a), a || (a = "");
      let c = window.tt.getLaunchOptionsSync().query.projectid;
      console.error("\u8bf7\u6c42projectid" + c), c || (c = ""), "" == s && (s = window.tt.getLaunchOptionsSync().query.promotionid, console.error("\u8bf7\u6c422.0promotionid" + s), s || (s = ""));
      let h = "2";
      window.Laya ? window.Laya.Browser.onIOS && (h = "1") : cc.sys.os == cc.sys.OS_IOS && (h = "1");
      let d = {
        channel: i,
        clickid: r,
        creativeid: n,
      ...
      zs_sdk.zs_network.dyReport(d).then(() => {});
    }
    static reportNextDayOpen() {
      let t = zs_sdk.zs_network.loginInfo.add_time,
        r = zs_sdk.zs_network.loginInfo.update_time;
      t && r && e.checkTime(t, r) && e.dyReport(e.event_type.next_day_open);
    }
    static checkTime(t, e) {
      let r = new Date(1e3 * t),
        i = r.getFullYear() + "-",
        n = (r.getMonth() + 1 < 10 ? "0" + (r.getMonth() + 1) : r.getMonth() + 1) + "-",
        o = r.getDate() + " ",
        s = new Date(i + n + o + "23:59:59"),
        a = s.getTime() / 1e3,
        c = s.getTime() / 1e3 + 86400;
      return e > a && e <= c;
    }
    static checkVideoReport(t) {
      let e = "2";
      window.Laya ? window.Laya.Browser.onIOS && (e = "1") : cc.sys.os == cc.sys.OS_IOS && (e = "1"), zs_sdk.zs_network.ztReport(e).then(() => {
        t && zs_sdk.zs_network.video();
      });
    }
  }
  e.event_type = {
...
}(window.zs_sdk = window.zs_sdk || {}), window.zs_sdk = window.zs_sdk || {};