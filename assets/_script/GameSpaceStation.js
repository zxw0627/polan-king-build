...
var def_GameSpaceStation = function (t) {
  function _ctor() {
    ...
    e.curGain_1 = null;
    e.getBg = null;
    e.info = $z1GameData.default.configInfo.spaceStation;
    e.data = $z1GameData.default.playerData.spaceStation;
    e.selectIndex = 0;
    e.table = [];
    e.curPriceCount = 0;
    return e;
  ...
  _ctor.prototype.initData = function () {
    ...
    var a = function (e) {
      ...
      $z1BundleManager.default.setSprite(a, "add/spaceStation/" + e, $z1BundleManager.default.uiBundle);
      n.table.push({
      ...
      c.on("touchend", function () {
        if ($z1GameData.default.UseCoin(h)) {
          $z1platform.default.tdReport("货币购买空间站");
          $z1SoundManager.default.playSound("click");
          $z1GameData.default.playerData.spaceStation.unlock[e] = 1;
  ...
  _ctor.prototype.getGain = function () {
    ...
    $z1GameData.default.playerData.res.coin += $z1GameData.default.playerData.spaceStation.curGain;
...
exports.default = def_GameSpaceStation;