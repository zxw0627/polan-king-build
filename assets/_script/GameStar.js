...
var def_GameStar = function (t) {
  function _ctor() {
    ...
    e.curGain_1 = null;
    e.getBg = null;
    e.info = $z1GameData.default.configInfo.star;
    e.data = $z1GameData.default.playerData.star;
    e.selectIndex = 0;
    e.table = [];
    e.curPriceCount = 0;
    return e;
  ...
  _ctor.prototype.initData = function () {
    ...
    var a = function (e) {
      ...
      $z1BundleManager.default.setSprite(a, "star/star_" + e, $z1BundleManager.default.uiBundle);
      n.table.push({
      ...
      c.on("touchend", function () {
        if ($z1GameData.default.UseCoin(h)) {
          $z1platform.default.tdReport("货币购买星球");
          $z1SoundManager.default.playSound("click");
          $z1GameData.default.unlockStar(e);
          t.refreshData();
        } else {
  ...
  _ctor.prototype.getGain = function () {
    ...
    $z1GameData.default.getStarGain();
    this.closeGetWindow();
    this.refreshData();
  };
