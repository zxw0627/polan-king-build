...
var def_GameUniverseCom = function (t) {
  function _ctor() {
  ...
  _ctor.prototype.onShow = function (e) {
    ...
    this.dataKey = e.dataKey;
    this.info = $z1GameData.default.configInfo[this.dataKey];
    this.data = $z1GameData.default.playerData[this.dataKey];
    var o = this.data.unlock.length;
    var a = this.info.name.length;
    for (var n = o; n < a; n++) {
      n >= this.data.unlock.length && this.data.unlock.push(0);
    }
    this.desName.getComponent(cc.Label).string = this.keyDir[this.dataKey] + "维修";
    this.panelDesName.getComponent(cc.Label).string = this.keyDir[this.dataKey] + "收入";
    $z1BundleManager.default.setSprite(this.head.node, "add/" + this.dataKey, $z1BundleManager.default.uiBundle);
  ...
  _ctor.prototype.initData = function () {
    ...
    var a = function (e) {
      ...
      $z1BundleManager.default.setSprite(a, "add/" + n.dataKey + "/" + n.info.name[e], $z1BundleManager.default.uiBundle);
      n.table.push({
      ...
      c.on("touchend", function () {
        if ($z1GameData.default.UseCoin(h)) {
          $z1platform.default.tdReport("货币购买" + t.keyDir[t.dataKey]);
  ...
  _ctor.prototype.refreshData = function () {
    ...
    console.log("🚀 ~ file: GameUniverseCom.ts:140 ~ GameStar ~ refreshData ~ this.data:", this.data);
    for (var e = 0; e < t; e++) {
  ...
  _ctor.prototype.getGain = function () {
    ...
    $z1GameData.default.playerData.res.coin += this.data.curGain;
    this.data.curGain = 0;
    $z1GameData.default.SaveData();
    this.closeGetWindow();
    this.refreshData();
  ...
  cc__decorate([ccp_property({
    type: cc.Node,
    displayName: "名字描述"
  })], _ctor.prototype, "desName", undefined);
  cc__decorate([ccp_property({
    type: cc.Node,
    displayName: "弹窗名字描述"
  })], _ctor.prototype, "panelDesName", undefined);
  cc__decorate([ccp_property({
    type: cc.Sprite,
    displayName: "title图片"
...
exports.default = def_GameUniverseCom;